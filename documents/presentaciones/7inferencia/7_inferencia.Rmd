...
output:
  ...
  xaringan::moon_reader:
    css: ["../xaringan_custom/xaringan-themer.css","../xaringan_custom/progress-bar.css","../xaringan_custom/header-footer.css","https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css"]c
    lib_dir: libs
    nature:
      slideNumberFormat:   |
