...
- El resto de la introducción usualmente se divide en dos secciones, que también son referidas como marco teórico, marco referencial, revisión bibliográfica, etc.
  ...
  - El segundo apartado corresponde a los conceptos relacionados con la variable dependiente (explanans) y en los cuales se basan las hipótesis. Se revisan en orden de relevancia. (al menos 5 referencias)
